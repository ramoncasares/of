...
\kern6pt
0 Life is a problem.
1 A problem is freedom and a condition.
2 Semantics cannot represent freedom,
\qquad which is free of meaning.
3 Syntax, with free terms, is needed to represent freedom.
4 A resolution is a syntactical transformation.
5 To represent resolutions, a recursive syntax is needed.
6 A symbolism, with semantics and recursive syntax,
\qquad can represent problems, resolutions, and solutions.
7 A subject is a symbolic live being.
8 Man is the only living subject.
9 Man is free and conscious.
